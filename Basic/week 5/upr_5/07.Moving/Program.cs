...
//output
if (allSpace >= allBoxes)
{
    Console.WriteLine($"{allSpace - allBoxes} Cubic meters left.");
}
else
{
    Console.WriteLine($"No more free space! You need {allBoxes - allSpace} Cubic meters more.");
}